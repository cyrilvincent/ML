...
trained = model.fit(X_train, Y_train, epochs=1, batch_size=120)
print(model.summary())
...
print(f"Nb weigths={calcNbW([32,64],[256],10,28,2,1)}") # Little difference because TF add always 1 weigth for bias
print(f"Nb iter for 1 inference={calcNbIter([32,64],[256],10,28,2,1)}")
