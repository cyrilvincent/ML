...
print(ytest)
print(ypred)
print(metrics.classification_report(ytest, np.round(ypred).astype(np.uint8).reshape(-1)))
print(metrics.confusion_matrix(ytest, np.round(ypred).astype(np.uint8).reshape(-1)))
